  ...
  <q-layout view="hHh Lpr lff" container style="height: 100vh" class="shadow-2 rounded-borders">
    <q-header elevated class="row no-wrap shadow-1 bg-black">
      ...
      <q-toolbar class="col-6">
        ...
        <q-toolbar-title>Wil</q-toolbar-title>
      </q-toolbar>
      ...
      songs: [
        {
          title: 'Shankara',
          artist: 'Panda Dub',
          src: require('../assets/musiques/panda-dub-shankara.mp3')
        },
        {
          title: 'Politic man',
          artist: 'Soom T',
          src: require('../assets/musiques/soom-t-politic-man.mp3')
        },
        {
          title: 'Moonlight',
          artist: 'XXXTentacion',
          src: require('../assets/musiques/xxxtentacion-moonlight.mp3')
        },
        {
          title: 'Lost memory',
          artist: 'Boris Brejcha',
          src: require('../assets/musiques/boris-brejcha-lost-memory.mp3')
        },
        {
          title: 'Walk',
          artist: 'Pantera',
          src: require('../assets/musiques/pantera-walk.mp3')
        },
        {
          title: 'Le bonheur',
          artist: "L'entourloop ft PandaDub",
          src: require('../assets/musiques/lentourloop-ft-panda-dub-le-bonheur.mp3')
        }
      ],
      player: new Audio()
    }
